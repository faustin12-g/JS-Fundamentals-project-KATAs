...
You get a point if you guessed correctly. The trick is you only have three seconds to 
...
the number of blue marbles pulled out so far (always lower than the starting number of 
blue marbles)
the number of red marbles pulled out so far (always lower than the starting number of red 
...
function guessBlue(blueStart, redStart, bluePulled, redPulled) {
    ...
    // Calculate the number of marbles remaining in the bag
    let remaining = total - (bluePulled + redPulled);
    
    // Calculate the probability of drawing a blue marble
    let probability = bluePulled / remaining;
    
    return probability;
}

var guessBlue = guessBlue(5, 5, 2, 3);
console.log(guessBlue);